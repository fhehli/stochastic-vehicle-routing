...
class City:
    def __init__(self, height: int, width: int, n_districts_y: int, n_districts_x: int, n_tasks: int, n_scenarios: int):
        ...
        self.end_times = None  
        self.task_routes = None # n_tasks x (src_vertex_id, dest_vertex_id)  
    ...
    def create_graph(self):
        ...
        for origin_id in job_tasks:
            ...
            # self.task_routes.add(()) # TODO add task start and end vertex position idxs so that we can get it in the feature computation
